...
<section id="main">
	<header class="page-header">
		<div class="container">
			<h1 class="title">
				<spring:message code="board.guide_writeform1" />
			</h1>
		</div>
	</header>
		...
		<div class="container form-group">
			<form action="" id="bofom" method="post" enctype="multipart/form-data">
				...
				<table class="table table-responsive center">
					<tr>
						<td>
							<h5><spring:message code="board.guide_writeform2" /></h5>
						</td>
						<td colspan="5">
					...
					<tr>
						...
						<td><input class="form-control" type="text"name="board_capacity" id="board_capacity"></td>
						...
						<td>
							<button type="button" id="convert"class="btn btn-success">
								<spring:message code="board.guide_writeform5.1" />
							</button>
						</td>
						<td><input class="form-control" id="after" type="text"name="price" placeholder="등록 후 수정 불가"></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td align="center">
							<button type="button" id="addBtn" class="btn btn-success">
								<spring:message code="board.guide_writeform10" />
							</button>
							<button type="button" id="minusBtn" class="btn btn-danger">
								<spring:message code="board.guide_writeform11" />
							</button>
						</td>
					</tr>
					<tr>
					...
					<tr>
						<td colspan="6" align="center">
							<input type="submit" id="success" class="btn btn-success" value="<spring:message code="board.guide_writeform12"/>">
							<input type="reset" class="btn btn-danger" value="<spring:message code="board.guide_writeform13"/>">
						</td>
					</tr>
				</table>
			</form>
