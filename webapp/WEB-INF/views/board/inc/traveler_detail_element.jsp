...
function getTimeStamp() {
	var d = new Date();
	var s = leadingZeros(d.getMonth() + 1, 2) + '/' + leadingZeros(d.getDate(), 2) + '/' + leadingZeros(d.getFullYear(), 4);
			...
			<article class="content product-page col-sm-12 col-md-12">
					...
					<div class="col-sm-5 col-md-5">
						<div class="image-box">
							<div class="general-img">
								<img class="replace-2x" alt="" src="${pageContext.request.contextPath}/resources/img/board_picture/${boarddto.BOARD_PICTURE1}" data-zoom-image="${pageContext.request.contextPath}/resources/img/board_picture/${boarddto.BOARD_PICTURE1}" width="500" height="500">
							</div>
							<!-- .general-img -->
							...
							<div class="thumblist-box load">
								...
								<div id="thumblist" class="thumblist">
									<a class="active" href="#" data-image="${pageContext.request.contextPath}/resources/img/board_picture/${boarddto.BOARD_PICTURE1}" data-zoom-image="${pageContext.request.contextPath}/resources/img/board_picture/${boarddto.BOARD_PICTURE1}">
					...
					<div class="col-sm-7 col-md-7">
						...
						<table class="table table-striped table-bordered text-center my-orders-table">
							...
							<tbody>
								<tr>
									<td>
										<a data-toggle="modal" id="callModal" data-target="#myModal">${boarddto.ID}</a>
									</td>
									<td>
										<c:choose>
							...
							<c:choose>
								<c:when test="${sessionScope.user_num == boarddto.USER_NUM}">
									<c:choose>
										<c:when test="${boarddto.BOARD_CAPACITY eq 1}">
											<a class="btn btn-default btn-sm" href="${pageContext.request.contextPath}/board/traveler_modify.htm?board_num=${boarddto.BOARD_NUM}">
											...
											<a class="btn btn-danger btn-sm" id="delete">
												...
												<spring:message code="board.traveler_detail0.4" /></a>
										</c:when>
										<c:otherwise>
								...
								<c:otherwise>
									<td>
										<c:choose>
											<c:when test="${boarddto.BOARD_CAPACITY eq 1}">
												<spring:message code="board.traveler_detail7" />
												<br>
												<br>
														...
														<c:otherwise>
															<c:choose>
																<c:when test="${sessionScope.country_code eq 82}">
																	<a class="btn add-cart btn-default btn-lg" href="${pageContext.request.contextPath}/board/travelerParty.htm?board_num=${boarddto.BOARD_NUM}&user_num=${sessionScope.user_num}">
																		<spring:message code="board.traveler_detail9" />
																	</a>
																	<br>
																</c:when>
																<c:otherwise>
																	<spring:message code="board.traveler_detail10" />
																	<br>
																</c:otherwise>
															</c:choose>
														</c:otherwise>
											...
											<c:otherwise>
												<spring:message code="board.traveler_detail11" />
												<br>
				...
				<div class="product-tab">
					<ul class="nav nav-tabs">
						...
						<li>
							<a href="#description"><spring:message code="board.traveler_detail14" /></a>
						</li>
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="product-tab">
					<ul class="nav nav-tabs">
						<li class="active">
							<a href="#profile"><spring:message code="board.traveler_detail15" /></a>
						</li>
						<li>
							<a href="#sendMessage"><spring:message code="board.traveler_detail16" /></a>
						</li>
						<li>
							<a href="#reporting"><spring:message code="board.traveler_detail17" /></a>
						</li>
					</ul>
					<!-- .nav-tabs -->
					<div class="tab-content">
							...
							<table class="table center">
								<tr>
									<td>
										...
										<input type="text" class="form-control" id="message_title" name="message_title" placeholder="메세지 제목 입력"></td>
								</tr>
								<tr>
									<td>
								...
								<tr>
									<td>
										<button class="btn btn-success" id="msg_btn"><spring:message code="board.traveler_detail22" /></button>
									</td>
								</tr>
							</table>
						</div>
						...
						<div class="tab-pane" id="reporting">
							<form action="${pageContext.request.contextPath}/report/report_write2.htm?reporter=${sessionScope.user_num}&villain=${boarddto.USER_NUM}&board_num=${boarddto.BOARD_NUM}" method="post">
								<table class="table center">
									<tr>
										<td><input type="text" class="form-control"placeholder="제목을 입력해주세요" name="report_title"></td>
									</tr>
									...
									<tr>
										<td>
											<input type="submit" class="btn btn-success" value="<spring:message code="board.traveler_detail22.1"/>"></td>
									</tr>
								</table>
							</form>
						</div>
			...
			<div class="modal-footer">
				<button type="button" class="btn btn-default" data-dismiss="modal">
					<spring:message code="board.traveler_detail23" />
				</button>
			</div>
		</div>
	</div>
