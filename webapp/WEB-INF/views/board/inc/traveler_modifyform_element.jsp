			...
			$.ajax({
			    ...
			    success: function(json) {
					...
					if($('#selectoption').val()=='KRW'){
						...
						swal({
							title: "실시간 환율 정보",
							text: '  $1= ￦'+json.quotes.USDKRW,
							imageUrl: ".././resources/img/dollar.png",
	...
	<article class="content">
		<div class="container">
			<form action="" method="post" enctype="multipart/form-data">
				<input type="hidden" name="user_num" value="${sessionScope.user_num}"> <input type="hidden" name="board_num" value="${boarddto.BOARD_NUM}">
				<table class="table center">
					...
					<tr>
						...
						<td>
							...
							수정전 파일 : 
							<input type="text" readonly="readonly" value="${boarddto.BOARD_PICTURE1}"> 
