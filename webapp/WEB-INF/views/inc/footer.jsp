			...
			<div class="row sidebar">
				<aside class="col-xs-12 col-sm-6 col-md-3 widget social">
					<div class="title-block">
						<h3 class="title">
							<spring:message code="index.footer1" />
						</h3>
					</div>
					<p>
						<spring:message code="index.footer2" />
					</p>
					<div class="social-list">
						<a class="icon rounded icon-facebook" href="https://www.facebook.com/serendipity112th">
							<i class="fa fa-facebook"></i>
						</a> 
						<a class="icon rounded icon-instagram" href="https://www.instagram.com/serendipity112th">
				...
				<aside class="col-xs-12 col-sm-6 col-md-3 widget newsletter">
					<div class="title-block">
						<h3 class="title">
							<spring:message code="index.footer3" />
						</h3>
					</div>
					<div>
						<p>
							<spring:message code="index.footer4" />
						</p>
						<div class="clearfix"></div>
				...
				<aside class="col-xs-12 col-sm-6 col-md-3 widget links">
					<div class="title-block">
						<h3 class="title">
							<spring:message code="index.footer5" />
						</h3>
					</div>
					<div>
						<img src="${pageContext.request.contextPath}/resources/img/KakaoTalk_20160628_114440625.png" width="300" height="200">
					</div>
				</aside>
				...
				<aside class="col-xs-12 col-sm-6 col-md-3 widget links">
					<div class="title-block">
						<h3 class="title">
							<spring:message code="index.footer10" />
						</h3>
					</div>
					<nav>
						<ul>
		...
		<div class="container">
			<div class="row">
				...
				<div class="address col-xs-6 col-sm-3 col-md-3">
					...
					<spring:message code="index.footer16" />
					&nbsp;
					<spring:message code="index.footer17" />
				</div>
