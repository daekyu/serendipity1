...
<section id="main" class="login-register">
	<header class="page-header">
		<div class="container">
			<h1 class="title">
				<spring:message code="member.join_login" />
			</h1>
		</div>
	</header>
	<div class="container">
			...
			<div class="content col-sm-12 col-md-12">
				<div class="row filter-elements hidden">
					<div class="col-xs-12 col-sm-6 col-md-6 box login">
						<div class="info-box">
							<h3 class="title">
								<spring:message code="member.join_login1" />
							</h3>
							<p class="descriptions">
								<spring:message code="member.join_login2" />
							</p>
							<button id="new-costumers" class="btn btn-default filter-buttons" data-filter=".register">
								<spring:message code="member.join_login3" />
							</button>
						</div>
					</div>
					...
					<div class="col-xs-12 col-sm-6 col-md-6 box login">
						<form class="form-box login-form form-validator" id="login_form" action="${pageContext.request.contextPath}/member/login.htm" method="post">
							<h3 class="title">
								<spring:message code="member.join_login4" />
							</h3>
							<p>
								<spring:message code="member.join_login5" />
							</p>

							<div class="form-group">
								<label>ID: <span class="required">*</span></label> 
								<input class="form-control" name="id" id="id_login" type="text">
							</div>
							...
							<div class="buttons-box clearfix">
								...
								<a href="${pageContext.request.contextPath}/member/recover_id_pw.htm" class="forgot">
									아이디/비밀번호를 잊으셨나요?
								</a> 
								<span class="required">
									<b>*</b> Required Field
					...
					<div id="joinDiv" class="col-xs-12 col-sm-6 col-md-6 box register">
						<h3 class="title">
							<spring:message code="member.join_login_re0.1" />
						</h3>
						<p>
							<spring:message code="member.join_login_re0.2" />
						</p>

						<form class="form-box register-form form-validator" action="joinMember.htm" method="post" id="joinMember">
							<div class="form-group">
								<label><spring:message code="member.join_login_re10" />
							...
							<div class="form-group">
								...
								<a id="req_confirm_num" class="btn btn-danger">
									<spring:message code="member.join_login_re0.4" />
								</a> 
								<a id="confirm" class="btn btn-danger">
									<spring:message code="member.join_login_re0.5" />
								</a>
							</div>

							<div class="form-group">
								<label><spring:message code="member.join_login_re" />
								<span class="required">*</span></label> 
								<input type="text" class="form-control" name="name" id="name">
							</div>

							<div class="form-group">
								<label><spring:message code="member.join_login_re1" />
								<span class="required" id="id_text">*</span></label> 
							...
							<div class="form-group">
								<label><spring:message code="member.join_login_re3" />
								<span class="required">*</span></label> 
								<input class="form-control" name="pw" id="pw_1" type="password">
							</div>

							<div class="form-group">
								<label><spring:message code="member.join_login_re4" />
								<span class="required">*</span></label> 
								<input class="form-control" id="confirm_pw" type="password">
							</div>

							<div class="form-group">
								<label><spring:message code="member.join_login_re5" />
								<span class="required">*</span></label> 
							...
							<div class="form-group">
								<label><spring:message code="member.join_login_re6" />
								<span class="required">*</span></label> 
								<input class="form-control" id="age" type="text">
							</div>

							<div class="form-group">
								<label><spring:message code="member.join_login_re7" />
								<span class="required">*</span></label> 
							...
							<div class="form-group" id="local">
								<label><spring:message code="member.join_login_re8" />
								<span class="required">*</span></label> 
								<select class="form-group" name="local_code" id="local_code">
									<option value="-">--</option>
									<c:forEach var="i" items="${local_list}">
										<option value="${i.local_code}">${i.local_name}/
											${i.local_code}</option>
									</c:forEach>
								</select>
							</div>
							...
							<div class="form-group">
								<label><spring:message code="member.join_login_re9" />
								<span class="required">*</span></label> 
					...
					<div class="col-xs-12 col-sm-6 col-md-6 box register">
						<div class="info-box">
							<h3 class="title">
								<spring:message code="member.join_login_re12" />
							</h3>
							<p class="descriptions">
								<spring:message code="member.join_login_re13" />
							</p>
							<button id="login-account" class="btn btn-default filter-buttons active-form" data-filter=".login">
								<spring:message code="member.join_login_re14" />
							</button>
						</div>
					</div>
				</div>
