...
<section id="main" class="login-register">
	<header class="page-header">
		<div class="container">
			<h1 class="title">
				<spring:message code="mypage.my_account_modify_information" />
			</h1>
		</div>
	</header>
	<div class="container">
			...
			<div class="col-sm-9 col-md-9 content">
				<div class="row filter-elements hidden">
					<div class="col-xs-12 col-sm-6 col-md-6 box login">
						<div class="info-box">
							<h3 class="title">
								<spring:message code="mypage.my_account_modify_information1" />
							</h3>
							<p class="descriptions">
								<spring:message code="mypage.my_account_modify_information2" />
							</p>
							<button id="new-costumers" class="btn btn-default filter-buttons" data-filter=".register">
								<spring:message code="mypage.my_account_modify_information3" />
							</button>
						</div>
					</div>
					...
					<div class="col-xs-12 col-sm-6 col-md-6 box login">
						<form class="form-box" action="InfoModify.htm" method="post" enctype="multipart/form-data">
							<h3 class="title">
								<spring:message code="mypage.my_account_modify_information4" />
							</h3>
					...
					<div class="col-xs-12 col-sm-6 col-md-6 box register">
						<form name="mo" class="form-box register-form form-validator" action="InfoModify2.htm?user_num=${sessionScope.user_num}" method="post">
							<h3 class="title">
								<spring:message code="mypage.my_account_modify_information9" />
							</h3>


							<div class="form-group">
								<label><spring:message code="mypage.my_account_modify_information10" /> 
								<span class="required">*</span></label> 
								<input type="text" class="form-control" name="name" value="${member_info.name}" readonly>
							</div>

							<div class="form-group">
								<label><spring:message code="mypage.my_account_modify_information11" /> 
								<span class="required">*</span></label> 
								<input type="text" class="form-control" name="id" value="${member_info.id}" readonly>
							</div>

							<div class="form-group">
								<label><spring:message code="mypage.my_account_modify_information12" /> 
								<span class="required">*</span></label> 
								<input class="form-control" name="pw" id="pw" type="password">
							</div>

							<div class="form-group">
								<label><spring:message code="mypage.my_account_modify_information13" /> 
								<span class="required">*</span></label> 
								<input class="form-control" id="confirm_pw" type="password">
							</div>

							<div class="form-group">
								<label><spring:message code="mypage.my_account_modify_information14" /> 
								<span class="required">*</span></label>
								<c:choose>
							...
							<div class="form-group">
								<label><spring:message code="mypage.my_account_modify_information15" />
								<span class="required">*</span></label> 
								<input class="form-control" id="age" type="text" value="${member_info.age}" readonly>
							</div>

							<div class="form-group">
								<label><spring:message code="mypage.my_account_modify_information16" /> 
								<span class="required">*</span></label> 
								<input class="form-control" id="age" type="text" value="${country}" readonly>
							</div>

							<div class="form-group" id="local">
								<label><spring:message code="mypage.my_account_modify_information17" /> 
								<span class="required">*</span></label> 
							...
							<div class="form-group">
								<label><spring:message code="mypage.my_account_modify_information18" /> 
								<span class="required">*</span></label> 
								<input class="form-control" id="hp" name="hp" type="text" placeholder="01012345678과 같이 '-'를 뺀 형식으로 입력하세요." value="${member_info.hp}">
							</div>

							<div class="form-group">
								<label><spring:message code="mypage.my_account_modify_information19" /> 
								<span class="required">*</span></label> 
					...
					<div class="col-xs-12 col-sm-6 col-md-6 box register">
						<div class="info-box">
							<h3 class="title">
								<spring:message code="mypage.my_account_modify_information21" />
							</h3>
							<p class="descriptions">
								<spring:message code="mypage.my_account_modify_information22" />
							</p>
							<button id="login-account" class="btn btn-default filter-buttons active-form" data-filter=".login">
								<spring:message code="mypage.my_account_modify_information23" />
							</button>
						</div>
					</div>
				</div>
