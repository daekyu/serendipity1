				...
				<ul class="list-unstyled">
				  <li>
					<div class="form-group">
					  ...
					  <input class="form-control" type="text" name="name" placeholder="Mr." required>
					</div>
					
					<div class="form-group">
					  <label>아이디: <span class="required">*</span></label>
					  <input class="form-control" type="text" name="id" placeholder="Alen" required>
					</div>
				  </li>
				  <li>
					<div class="form-group">
				  ...
				  <li>
					<div class="form-group">
					  <label>취미: <span class="required">*</span></label>
					  <div>
						  <c:forEach var="i" items="${hobby_list}">
						  	${i.hobby_name}<input type="checkbox" name="hobby" value="${i.hobby_code}"> 
						  </c:forEach>
						  aaa<input class="form-control" type="checkbox" name="hobby" value="">
					  </div>
					</div>
				  </li>
				</ul>
				...
				<ul class="list-unstyled">
				  <li>
					<div class="form-group">
					  ...
					  <input class="form-control" id="age" type="text" required>
					</div>
					<div class="form-group">
