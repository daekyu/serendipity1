		...
		<div class="row">
			<article class="col-sm-9 col-md-9 content">
							...
							여행자 구함
												...
												<c:choose>
													<c:when test="${i.STATE eq 'wait'}">
														...
														<a href="${pageContext.request.contextPath}/mypage/delete_send_history.htm?user_num=${sessionScope.user_num}&parti_num=${i.PARTI_NUM}&check=1"
															class="btn btn-danger delete">취소</a>
														</c:when>
														<c:otherwise>
															마감
														</c:otherwise>
			  ...
			  <li><a href="#"><i class="fa fa-angle-right"></i></a></li> -->
						...
						<br>임시 출력창 <br>page: ${page}<br> maxpage:
						${maxpage}<br> startpage: ${startpage}<br> endpage:
						${endpage}<br> listCount: ${listCount}<br>
