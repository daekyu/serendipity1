...
<section id="main">
	<header class="page-header">
		<div class="container">
			<h1 class="title">
				<spring:message code="travel.info" />
			</h1>
		</div>
	</header>
						...
						$(function() {
							$.ajax({
								...
								success : function(data) {
									...
									var infowindow = new google.maps.InfoWindow({content: document.getElementById('myModal')});
									var marker, i;
					...
					<div class="tab-content">
						<div class="tab-pane active" id="localInfo">
							<table class="table table-bordered">
								<thead>
									<tr>
										<th colspan="6" class=""><span id="local_name"></span>
										<spring:message code="travel.inca2.5" /></th>
									</tr>
								</thead>
						...
						<div class="tab-pane" id="review">
							...
							<ul class="latest-posts" id="review_list">
								<c:forEach var="i" begin="0" end="2" step="1">
									<li>
										<a href="#" id="review_imglink${i}">
											<img class="image img-circle replace-2x" id="review_img${i}" src="content/img/product-1-84.jpg" alt="" title="" width="84" height="84" data-appear-animation="rotateIn">
										</a>
										<div class="meta">
											<a href="#" id="review_titlelink${i}">
												<span class="daekyu" id="review_title${i}"></span>
											</a>
										</div>
										<div class="description">
											<a href="#" id="review_content${i}"> </a>
										</div>
									</li>
								</c:forEach>
							</ul>
