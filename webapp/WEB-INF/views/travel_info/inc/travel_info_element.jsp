					...
					<div class="tab-content">
						...
						<div class="tab-pane active" id="description">
							...
							<table class="table table-bordered">
								<thead>
									<tr>
										<th colspan="6" class=""><span id="local_name"></span>지역의
											정보를 확인하세여</th>
									</tr>
								</thead>
								...
								<tbody>
									<tr>
										<td rowspan="2">
											<div data-appear-animation="bounceInLeft">
												<div class="icon">
													<div class="livicon" data-n="phone" data-s="42"
														data-c="000" data-hc="0"></div>
												</div>
											</div>
										</td>
										<td>지역번호</td>
										<td rowspan="2">
											<div data-appear-animation="bounceInUp">
												<div class="icon">
													<div class="livicon" data-n="money" data-s="42"
														data-c="000" data-hc="0"></div>
												</div>
											</div>
										</td>
										...
										<td rowspan="2">
											<div data-appear-animation="bounceInRight">
												<div class="icon">
													<div class="livicon" data-n="car" data-s="42" data-c="000"
														data-hc="0"></div>
												</div>
											</div>
										</td>
									...
									<tr>
										<td rowspan="2">
											<div data-appear-animation="bounceInLeft">
												<div class="icon">
													<div class="livicon" data-n="pacman" data-s="42"
														data-c="000" data-hc="0"></div>
												</div>
											</div>
										</td>
										...
										<td rowspan="2">
											<div data-appear-animation="bounceInDown">
												<div class="icon">
													<div class="livicon" data-n="home" data-s="42" data-c="000"
														data-hc="0"></div>
												</div>
											</div>
										</td>
										...
										<td rowspan="2">
											<div data-appear-animation="bounceInRight">
												<div class="icon">
													<div class="livicon" data-n="plane-up" data-s="42"
														data-c="000" data-hc="0"></div>
												</div>
											</div>
										</td>
						...
						<div class="tab-pane" id="reviews">
							...
							<div class="title-box">
								<a href="#" class="btn">More <span
									class="glyphicon glyphicon-arrow-right"></span></a>
							</div>
							<ul class="latest-posts">
								<li><a href="#"><img
										class="image img-circle replace-2x"
										src="content/img/product-1-84.jpg" alt="" title="" width="84"
										height="84" data-appear-animation="rotateIn"></a>
									<div class="meta">
										<a href="#"><span class="daekyu">인기 여행기 글 제목
												abcdefg...1</span></a>
									</div>
									<div class="description">
										<a href="#"> 인기 여행기 글 내용 일부......1 </a>
									</div></li>
