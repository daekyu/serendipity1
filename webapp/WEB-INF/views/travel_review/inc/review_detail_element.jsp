...
<section id="main">
	<header class="page-header">
		<div class="container">
			<h1 class="title">
				<spring:message code="board.review_detail" />
			</h1>
		</div>
	</header>
	<div class="container">
			...
			<div class="content portfolio col-sm-12 col-md-12">
				...
				<div class="row">
					<div class="portfolio-tags bottom-padding col-sm-4 col-md-4">
						<p>
							<b><spring:message code="board.review_detail2" /></b><span>${review_detail.LOCAL_NAME}</span>
						</p>
						<p>
							<b><spring:message code="board.review_detail3" /></b><span>${review_detail.REVIEW_DATE}</span>
						</p>
						<br>
						<h4>
							<span id="likeCount">${count}</span> Like(s)
						</h4>

						<div class="icon circle bg icon-40" data-s="48" data-op="0" data-c="#c10841" data-hc="0" id="btn_like">
							<i class="fa fa-heart-o"></i>
						</div>
						<div class="icon circle bg icon-40" data-s="48" data-op="0" data-c="#c10841" data-hc="0" id="btn_like2">
						...
						<c:choose>
							<c:when test="${sessionScope.user_num == review_detail.USER_NUM}">
								<a class="btn btn-default btn-sm" href="${pageContext.request.contextPath}/travel_review/review_updateform.htm?review_num=${review_detail.REVIEW_NUM}">
									<i class="livicon shadowed" data-s="24" data-n="pen" data-c="white" data-hc="0"></i> 
									<spring:message code="board.review_detail4" />
								</a>
								<a class="btn btn-danger btn-sm" id="delete" href="${pageContext.request.contextPath}/travel_review/review_delete.htm?review_num=${review_detail.REVIEW_NUM}">
									<i class="livicon shadowed" data-s="24" data-n="trash" data-c="white" data-hc="0"></i> 
									<spring:message code="board.review_detail5" />
								</a>
							</c:when>
						</c:choose>
					</div>
				...
				<div class="product-tab">
					<ul class="nav nav-tabs">
						<li>
							<a href="#reviews"><spring:message code="board.review_detail6" /></a>
						</li>
					</ul>
					<!-- .nav-tabs -->
						...
						<div class="tab-pane active" id="reviews">
								...
								<c:forEach var="i" items="${reply_list}">
									<li class="">
										<div class="row">
											...
											<div class="meta">
												<span>
													<b>${i.ID}</b></span>, <span class="time"><b>${i.REPLY_DATE}</b>
													<c:choose>
														<c:when test="${sessionScope.user_num == i.USER_NUM}">
															<a href="reply_delete.htm?reply_num=${i.REPLY_NUM}&review_num=${review_detail.REVIEW_NUM}">
															<spring:message code="board.review_detail7" /></a>
														</c:when>
													</c:choose> 
												</span>
											</div>
							...
							<form class="comments-form" action="review_detail.htm?user_num=${sessionScope.user_num}&review_num=${review_detail.REVIEW_NUM}" method="post">
								<div class="row">
									<div class="row">
										<label>
											<spring:message code="board.review_detail8" />
											<span class="required">*</span>
										</label> 
										<input type="text" class="form-control" name="reply_content" style="width: 85%">
										<input type="submit" class="btn btn-default" value="<spring:message code="board.review_detail9"/>">
